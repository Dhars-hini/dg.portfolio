        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="order-2 lg:order-1">
            ...
            <motion.h1
              ...
              className="mt-6 font-display text-4xl font-bold leading-[1.07] tracking-tight sm:text-5xl lg:text-[3.5rem] xl:text-6xl"
            >
              Hi, I&apos;m{" "}
            ...
            <motion.div
              ...
              className="mt-4 h-8 text-lg font-medium sm:text-xl"
            >
              <TypingText />
            </motion.div>
            ...
            >
              <a
                href="#projects"
                className="group relative overflow-hidden rounded-full bg-primary px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-primary/25 transition-all hover:scale-[1.03] hover:shadow-primary/40 active:scale-[0.98]"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-border bg-surface/60 px-6 py-2.5 text-sm font-medium backdrop-blur-sm transition-all hover:border-primary/50 hover:scale-[1.02]"
              >
                <Download size={14} /> Resume
              </a>
              <a
                href="#contact"
                className="rounded-full px-5 py-2.5 text-sm font-medium text-muted transition-colors hover:text-text"
              >
                Contact Me
              </a>
            </motion.div>
            ...
            >
              ...
              <div className="ml-2 flex items-center gap-1.5 rounded-full border border-border bg-surface/60 px-3 py-1.5 backdrop-blur-sm">
          ...
          {/* ── RIGHT: Profile photo + floating decorations ───────────── */}
          <motion.div
          ...
          >
            <div className="relative">
              ...
              >
                ...
                />
                {/* All-sides fade overlay — matches background in both modes */}
                <div
                  className="absolute inset-0 pointer-events-none"
                  style={{
                    background: `
                      radial-gradient(ellipse 85% 90% at 50% 45%, transparent 40%, var(--background) 78%)
                    `,
                  }}
                />
              </div>
              ...
              <motion.div
                ...
                className="absolute -bottom-2 -left-4 flex items-center gap-2 rounded-2xl border border-border bg-surface/80 px-3.5 py-2 shadow-lg backdrop-blur-md"
              >
                <span className="h-2 w-2 animate-pulse rounded-full bg-emerald-400" />
              ...
              <motion.div
                ...
                className="absolute -top-2 -right-4 flex items-center gap-2 rounded-2xl border border-border bg-surface/80 px-3.5 py-2 shadow-lg backdrop-blur-md"
              >
